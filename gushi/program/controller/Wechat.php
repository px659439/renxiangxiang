...
//获取openid并判断是否跳到小程序
	public function getcode(){
		...
		$AppSecret = '9c6a4bd3baf30ed3bdf468957158d2da';
...
//分享获取用户user_ID  openid并判断是否跳到小程序
	...
	//回复微信客服消息
	public function send_message($fromUsername)
	{
	    $data = array(
	        "touser" => $fromUsername,
	        "msgtype" => 'link',
	        "link"	=> array(
		        ...
		        "url"=>'https://sixone.kkmandarin.cn/poetry.html',
